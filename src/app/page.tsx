            ...
            <div className="flex flex-col md:flex-row items-start md:items-center md:justify-between">
              <div className="md:max-w-md lg:max-w-lg">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <a href="/images/Ben_Sorensen_2025_Resume.pdf" target="_blank" rel="noopener noreferrer" className="border border-gray-700 text-white px-6 py-3 rounded-full text-sm font-medium italic font-body transition-all duration-300 hover:bg-white/10 hover:border-white hover:shadow-lg hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50">Resume</a>
